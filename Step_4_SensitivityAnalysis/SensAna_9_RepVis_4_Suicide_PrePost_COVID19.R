...
Results <- list.files(
  path = "../Res_2_Results/ResSensAna_PrePost_COVID19_Suicide/",
  pattern = "Res.*xlsx",
  full.names = T) %>%
...
p <- AllRes %>%
  ...
  scale_x_continuous(limits = c(83.5, 87)) +  # 设置Y轴的值范围
...
ggsave('../Res_2_Results/ResSensAna_PrePost_COVID19_Suicide/SensRes_Res_COVID19_Suicide.svg',
       width = 8,
       height = 6,
       plot = p)
...
ggsave('../Res_2_Results/ResSensAna_PrePost_COVID19_Suicide/SensRes_CoefErrorBar_COVID19_Suicide.svg',
       width = 10,
       height = 8,
       plot = p)

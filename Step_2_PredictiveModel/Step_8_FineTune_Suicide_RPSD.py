...
"""
Predictive Modeling Step 8
    Hyperparameter Optimization: Fine-tuning within a narrow range
    Target: Suicidal Ideation
    
Created on Sat Apr 22 15:18:11 2023
...
L2Norm_pool = np.linspace(Opt_L2*0.5,Opt_L2*1.5,100)
#%% Import Self-defined modules by Kunru Song
# Create a folder to save the results of this script
if not os.path.exists('../Res_2_Results/ResML_OptimeHyperpara_Suicide'):
    os.mkdir('../Res_2_Results/ResML_OptimeHyperpara_Suicide')
# # Create Log File for this script
log_file_name = '../Res_1_Logs/Log_ML_8_Optim_Suicide.txt'
...
IterResult = RerunModelPipeline(100,clfset,L2Norm_pool,Partition,
                                ...
                                K_matchedneg)
IterResult.to_excel('../Res_2_Results/ResML_OptimeHyperpara_Suicide/ResML_L2Logit_FineTune_IterNum100.xlsx')
#%% End of this script
myLogger.close()

# -*- coding: utf-8 -*-
"""
Predictive Modeling Step 4
    Feature Selection: Recursive Feature Elimination
    Target: Suicidal Ideation
    
Created on Thu Apr 20 16:51:54 2023
...
if not os.path.exists('../Res_2_Results/ResML_RFECV_Suicide'):
    os.mkdir('../Res_2_Results/ResML_RFECV_Suicide')
# # Create Log File for this script
log_file_name = '../Res_1_Logs/Log_ML_4_RFECV_Suicide.txt'
...
IterResult.to_excel('../Res_2_Results/ResML_RFECV_Suicide/ResML_L2Logit_RFECV_IterNum1000.xlsx')
#%% End of this script
myLogger.close()

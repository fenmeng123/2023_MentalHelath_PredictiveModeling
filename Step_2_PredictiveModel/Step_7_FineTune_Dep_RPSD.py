# -*- coding: utf-8 -*-
"""
Predictive Modeling Step 7
    Hyperparameter Optimization: Fine-tuning within a narrow range
    Target: Depression
    
Created on Sat Apr 22 20:55:39 2023
...
log_file_name = '../Res_1_Logs/Log_ML_7_Optim_Dep.txt'
...
IterResult = RerunModelPipeline(100,clfset,L2Norm_pool,Partition,
                                ...
                                K_matchedneg)
IterResult.to_excel('../Res_2_Results/ResML_OptimeHyperpara_Dep/ResML_L2Logit_FineTune_IterNum100.xlsx')
#%% End of this script
myLogger.close()

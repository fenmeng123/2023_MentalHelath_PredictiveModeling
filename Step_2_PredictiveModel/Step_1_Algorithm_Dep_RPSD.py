# -*- coding: utf-8 -*-
"""
Predictive Modeling Step 1
    Choosing Machine-learning Algorithm using trainning data
    Target: Depression
    
Created on Mon Apr 17 10:10:04 2023
...
if not os.path.exists('../Res_2_Results/ResML_CompareAlogrithm_Dep'):
    os.mkdir('../Res_2_Results/ResML_CompareAlogrithm_Dep')
# # Create Log File for this script
log_file_name = '../Res_1_Logs/Log_ML_1_CompareAlgorithem_Depression.txt'
...
M0_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M0_IterNum1000.xlsx')
...
M1_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M1_IterNum1000.xlsx')
# Ridge Classifier
...
M2_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M2_IterNum1000.xlsx')
# linear SVC
...
M3_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M3_IterNum1000.xlsx')
# perceptron
...
M4_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M4_IterNum1000.xlsx')
...
M5_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M5_IterNum1000.xlsx')
...
M6_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M6_IterNum1000.xlsx')
...
M7_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M7_IterNum1000.xlsx')
# KNN
...
M8_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M8_IterNum1000.xlsx')
# Gaussian SVC
...
M9_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M9_IterNum1000.xlsx')
...
M10_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M10_IterNum1000.xlsx')
# Sigmoid SVC
...
M11_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M11_IterNum1000.xlsx')
# MLP
...
M12_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M12_IterNum1000.xlsx')
...
M13_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M13_IterNum1000.xlsx')
...
M14_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M14_IterNum1000.xlsx')
# Gaussian Process Classifier
clfset = Mdl_Pipe('M15_GPC')
clfset.GaussianProcessClassifier()
M15_IterResult = RerunModelPipeline(1000,clfset,Partition,feature_pool,test_prop,train_prop,K_matchedneg)
M15_IterResult.to_excel('../Res_2_Results/ResML_CompareAlogrithm_Dep/ResML_M15_IterNum1000.xlsx')

# -*- coding: utf-8 -*-
"""
Predictive Modeling Step 12
    Subgroup Analysis for Predictive Modeling
    Target: Suicidal Ideation
    
Created on Thu Apr 27 01:10:49 2023
...
if not os.path.exists('../Res_2_Results/ResML_Subgroup_Suicide'):
    os.mkdir('../Res_2_Results/ResML_Subgroup_Suicide')

def RunWeightedMdl_Subgroup(train_dat,test_dat,X_Name,Y_Name,Opt_L2,FileName):
    mdl = Mdl_Pipe('L2Logit_Suicide',X_Name,Y_Name)
